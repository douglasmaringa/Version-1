    ...
    <div class="osahan-checkout">
        <div class="d-none">
            <div class="bg-primary border-bottom p-3 d-flex align-items-center">
                ...
                <h4 class="font-weight-bold m-0 text-white">{t("checkout")}</h4>
            </div>
        </div>
                        ...
                        <div class="osahan-cart-item mb-3 rounded shadow-sm bg-white overflow-hidden">
                            <div class="osahan-cart-item-profile bg-white p-3">
                                <div class="d-flex flex-column">
                                    <h6 class="mb-3 font-weight-bold">{t("address")}</h6>
                                    <div class="row">
                                    ...
                                    <a class="btn btn-success" href="index.html"  style={{"color":"yellow"}} data-toggle="modal" data-target="#exampleModal">{t("new")} </a>
                                </div>
                            </div>
                        </div>
                        <div class="accordion mb-3 rounded shadow-sm bg-white overflow-hidden" id="accordionExample">
                            <div class="osahan-card bg-white border-bottom overflow-hidden">
                                <div class="osahan-card-header" id="headingOne">
                                 ...
                                 <i class="feather-credit-card mr-3"></i> Personal Info
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="osahan-card-body border-top p-3">
                                        <h6 class="m-0"></h6>
                                        <p class="small">{t("accept")} <span class="osahan-card ml-2 font-weight-bold">( iDeal/Cash )</span></p>
                                        <div>
                                            <div class="form-row">

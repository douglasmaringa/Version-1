            ...
            <div class="pb-4">
                <div class="row">
                    <div class="col-6 col-md-2">
                        <p class="text-white-50 font-weight-bold m-0 small">{t("delivery")}</p>
                        <p class="text-white m-0">{t("free")}</p>
                    </div>
                    <div class="col-6 col-md-2">
                        <p class="text-white-50 font-weight-bold m-0 small">{t("time")}</p>
    ...
    <div class="container ">
        <div class="p-3 btn-success mt-n3 rounded position-relative">
            <div class="d-flex align-items-center">
                ...
                <a href="contact-us.html" class="btn btn-sm btn-outline-light ml-auto">{t("contact")}</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-8 pt-3">
                <div class="shadow-sm rounded bg-white mb-3 overflow-hidden">
                    ...
                    <div class="row m-0">
                        <h6 class="p-3 m-0 font-weight-bold w-100">Menu <small class="text-black-50">{data.length} {t("items")}</small></h6>
                        <div class="col-md-12 px-0 border-top">
                            {/*Map in the spaces*/}
                            {
                                data.map((e)=>(
                                    <div class="p-3 border-bottom gold-members">
                                    <span class="float-right"><button onClick={()=>{addToBasket(e)}} class="btn-success btn-outline-secondary btn-sm" style={{"color":"white"}} data-toggle="modal" data-target="#extras">{t("add")}</button></span>
                                    <div class="media">
                                        <div class="mr-3" style={{"border-radius":"20px"}}>
                ...
                <div class="mb-3">
                    ...
                    <div class="bg-white p-3 mb-3 restaurant-detailed-ratings-and-reviews shadow-sm rounded">
                        <a class="text-primary float-right" href="index.html">{t("top")}</a>
                        <h6 class="mb-1">{t("ratings")}</h6>
        ...
        switch (e.stars) {
          ...
          <ul class="rating-stars list-unstyled">
                    ...
                    <div class="bg-white p-3 rating-review-select-page rounded shadow-sm">
                        <h6 class="mb-3">{t("comment")}</h6>
                        <div class="d-flex align-items-center mb-3">
                            <p class="m-0 small">{t("rate")}</p>
                            <div class="star-rating ml-auto">
                                <input placeholder="number between 1-5" type="number" value={stars} onChange={(e)=>{setStars(e.target.value)}} />
                            </div>
                        </div>
                        <div >
                            <div class="form-group"><label class="form-label small">Jouw commentaar</label><textarea class="form-control" value={comment} onChange={(e)=>{setComment(e.target.value)}}></textarea></div>
                            <div class="form-group mb-0"><button onClick={submit} type="button" class="btn btn-success btn-block" style={{"color":"yellow"}}> {t("submitcomment")} </button></div>
                        </div>
                    </div>
                </div>
            </div>
